...
# --------------------------------------MAIN BUTTONS---------------------------------------------------
Label(window, text="Please enter login details",background="white").grid(row=1, column=1)
Label(window, text="",background="white").grid(row=2)
Label(window, text="Username",background="white").grid(row=3, column=1)
...
Label(window, text="Password",background="white").grid(row=6, column=1)
password__login_entry = Entry(window, textvariable="password", show= '*')
password__login_entry.grid(row=7, column=1)
Label(window, text="",background="white").grid(row=8, column=1)
Button(window, text="Login", width=10, height=1, command=lambda : mainPage(window)).grid(row=9, column=1)
