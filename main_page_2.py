...
button2 = Button(window, text="ID: 2020218", compound=TOP, image=button2_image, background="white", activeforeground="white", activebackground="white", borderwidth=0)
button2.grid(row=1, column=1)

# button 3
button3_image = PhotoImage(file = "Assets/button3_2.png")
button3 = Button(window, image=button3_image, background="white", activeforeground="white", activebackground="white", borderwidth=0)
...
button4 = Button(window, image=button4_image, background="white", activeforeground="white", activebackground="white", borderwidth=0)
